class SiteController < ApplicationController
  ...
  def create
    ...
    self.instance_variable_set("@#{"imageside"}", ActiveRecord::Base.const_get("Imageside").create(@filename.name, funique, params[:url].join("/"), session[:image_side], MAX_IMAGESIDE))
