class CreateImagesides < ActiveRecord::Migration
  def self.up
    create_table :imagesides do |t|
      ...
      t.column :rank,             :integer   # not associated with attachment_fu
      t.column :href,             :text   # not associated with attachment_fu
      t.column :caption,          :text   # not associated with attachment_fu
      t.column :show,             :boolean   # not associated with attachment_fu
      t.timestamps
    end
  end

  def self.down
    drop_table :imagesides
  end
end
